  ...
  return (
    <div ref={heroRef} className="min-h-[80vh] flex flex-col items-center justify-center text-center px-4 relative">
      ...
      <div className="hero-element inline-flex items-center gap-2 bg-surface border border-borderGray px-4 py-2 rounded-full mb-8 backdrop-blur-md">
        ...
        <span className="text-xs font-semibold tracking-widest text-textMuted uppercase">Season 4 is Live</span>
      </div>
      ...
      <div className="hero-element mt-24 w-full max-w-5xl glass-panel p-8 flex flex-col md:flex-row items-center justify-between">
         <div className="text-left">
           <h3 className="text-2xl font-bold font-display mb-2 text-white">Latest Match</h3>
           <p className="text-textMuted">Season 4 • Group Stage</p>
         </div>
         <div className="flex items-center gap-8 my-6 md:my-0">
           <div className="flex flex-col items-center">
             <img src="https://ui-avatars.com/api/?name=Faker&background=random" className="w-16 h-16 rounded-full border-2 border-borderGray" alt="Faker" />
             <span className="mt-2 font-semibold text-white">Faker</span>
           </div>
           <div className="text-3xl font-black text-accent">3 - 1</div>
           <div className="flex flex-col items-center">
             <img src="https://ui-avatars.com/api/?name=Chovy&background=random" className="w-16 h-16 rounded-full border-2 border-borderGray" alt="Chovy" />
             <span className="mt-2 font-semibold text-white">Chovy</span>
           </div>
         </div>
      </div>
    </div>
